...
from courses.models import Certificate, Choice, Course, Enrollment, Lesson, Module, Question, UserProgress
...
COURSES_DATA = [
    ...
    (
        ...
        "Master composition, hooks, and performance optimization for large-scale apps.",
        "https://images.unsplash.com/photo-1633356122544-f134324a6cee?w=800&q=80",
    ),
    (
        "NextJS",
        "Next.js 14 Full Stack",
        "Build server-side rendered apps with App Router and Server Actions.",
        "https://images.unsplash.com/photo-1618477247222-ac5912454594?w=800&q=80",
    ),
    (
        "CSS",
    ...
    (
        ...
        "From Closures to Promises: The deep dive you need.",
        "https://images.unsplash.com/photo-1579468118864-1b9ea3c0db4a?w=800&q=80",
    ),
    (
        "Design",
        "UI/UX Design with Figma",
        "Design beautiful interfaces and prototype like a pro.",
    ...
    (
        ...
        "From Pandas to Neural Networks in 30 days.",
        "https://images.unsplash.com/photo-1526379095098-d400fd0bf935?w=800&q=80",
    ),
    (
        "Django",
        "Django REST Framework",
        "Build scalable APIs for mobile and web applications.",
        "https://images.unsplash.com/photo-1515879218367-8466d910aaa4?w=800&q=80",
    ),
    (
        "Go",
        "Golang Backend Engineering",
        "High performance microservices with Go and gRPC.",
        "https://images.unsplash.com/photo-1618335829737-2228915674e0?w=800&q=80",
    ),
    (
        "Node",
        "Node.js Microservices",
        "Event-driven architecture with Express and Kafka.",
        "https://images.unsplash.com/photo-1603302576837-37561b2e2302?w=800&q=80",
    ),
    (
        "SQL",
        "The Complete SQL Bootcamp",
        "Zero to Hero: PostgreSQL, MySQL and Database Design.",
    ...
    (
        ...
        "Containerization and Orchestration for modern DevOps.",
        "https://images.unsplash.com/photo-1605745341117-9575522cd768?w=800&q=80",
    ),
    (
        "AWS",
        "AWS Certified Solutions Architect",
        "Pass the SAA-C03 exam with hands-on labs.",
        "https://images.unsplash.com/photo-1451187580459-43490279c0fa?w=800&q=80",
    ),
    (
        "Linux",
        "Linux Command Line",
        "Master the shell, scripting, and server management.",
    ...
    (
        ...
        "Scale applications to millions of users (Load Balancing, Caching).",
        "https://images.unsplash.com/photo-1519389950473-47ba0277781c?w=800&q=80",
    ),
    (
        "Algo",
        "Data Structures in Java",
        "Ace your coding interviews: Graphs, Trees, and DP.",
        "https://images.unsplash.com/photo-1555066931-4365d14bab8c?w=800&q=80",
    ),
    (
        "Security",
        "Cybersecurity Fundamentals",
        "Ethical hacking, network defense, and OWASP Top 10.",
    ...
    (
        ...
        "Build models with Scikit-Learn, TensorFlow and PyTorch.",
        "https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=800&q=80",
    ),
    (
        "Web3",
        "Blockchain & Solidity",
        "Build Smart Contracts and DApps on Ethereum.",
        "https://images.unsplash.com/photo-1639762681485-074b7f938ba0?w=800&q=80",
    ),
    (
        "Mobile",
        "Flutter & Dart",
        "Build native iOS and Android apps with one codebase.",
        "https://images.unsplash.com/photo-1551650975-87deedd944c3?w=800&q=80",
    ),
    (
        "Rust",
        "Rust Programming",
        "Memory safety without garbage collection. Build fast systems.",
        "https://images.unsplash.com/photo-1565153907400-7e01a9ab25f3?w=800&q=80",
    ),
]
...
QUIZ_BANK = {
    ...
    "SQL": (
        "Which command removes all records but keeps the table structure?",
        [("TRUNCATE", True), ("DROP", False), ("DELETE", False)],
    ),
    "Docker": (
        "What file defines the image structure?",
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        admin, _ = User.objects.get_or_create(
            username="admin", defaults={"email": "admin@c.com", "is_staff": True, "is_superuser": True}
        )
        ...
        for index, (category, title, desc, thumb) in enumerate(COURSES_DATA):
            course = Course.objects.create(instructor=admin, title=title, description=desc, thumbnail_url=thumb)
    ...
    def complete_course_for_user(self, course, user):
        ...
        for lesson in lessons:
            UserProgress.objects.create(user=user, lesson=lesson, is_completed=True, is_quiz_passed=True)
